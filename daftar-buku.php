...
<html lang="en">
  <head>
    ...
    <title>Rak Digital - Daftar Buku</title>
  ...
  <body>
	...
	<section id="daftar-buku" class="mt-5 pt-5  ">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body text-start">
                ...
                <?php if (isset($_SESSION['username'])): ?>
                  <?php if ($tampildata['status'] == 'Tersedia'): ?>
                    <a href="" class="w-100 btn btn-success" onclick="alert('Anda Meminjam Buku Ini')">Pinjam</a>
                  <?php else: ?>
                    <div class="w-100 btn btn-secondary disabled">Sedang Dipinjam</div>
                  <?php endif; ?>
                <?php endif; ?>
              </div>
            </div>
